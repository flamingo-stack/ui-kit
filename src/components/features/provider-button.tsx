...
// SVG icons for providers (embedded to avoid external dependencies)
const PROVIDER_ICONS = {
  ...
  slack: (
    <svg className="w-5 h-5" viewBox="0 0 24 24">
      <path fill="#E01E5A" d="M6 15a2 2 0 01-2-2V9a2 2 0 012-2 2 2 0 012 2v4h4a2 2 0 012 2 2 2 0 01-2 2H8a2 2 0 01-2-2z"/>
      <path fill="#36C5F0" d="M5 12a2 2 0 01-2-2V8a2 2 0 012-2 2 2 0 012 2v2a2 2 0 01-2 2zM19 12a2 2 0 01-2-2V8a2 2 0 012-2 2 2 0 012 2v2a2 2 0 01-2 2z"/>
      <path fill="#2EB67D" d="M12 19a2 2 0 01-2-2v-4H6a2 2 0 01-2-2 2 2 0 012-2h4V5a2 2 0 012-2 2 2 0 012 2v4h4a2 2 0 012 2 2 2 0 01-2 2h-4v4a2 2 0 01-2 2z"/>
      <path fill="#ECB22E" d="M12 5a2 2 0 01-2-2V1a2 2 0 012-2 2 2 0 012 2v2a2 2 0 01-2 2zM12 19a2 2 0 01-2-2v-2a2 2 0 012-2 2 2 0 012 2v2a2 2 0 01-2 2z"/>
    </svg>
  ),
  github: (
